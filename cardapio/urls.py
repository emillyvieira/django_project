...
from cardapio.views import lojas, loja_detail, LojaCreateView, LojaUpdateView, LojaDeleteView
...
urlpatterns = [
	...
	path('loja/<int:pk>/delete', LojaDeleteView.as_view(), name="loja_delete"),
]
